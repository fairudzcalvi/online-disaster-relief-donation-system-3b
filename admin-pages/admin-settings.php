  ...
  <aside class="sidebar">
    ...
    <nav class="side-nav">
      <ul>
        ...
        <li><a href="admin-settings.php" class="nav-link active"><i class="fa-solid fa-gear"></i> Settings</a></li>
      </ul>
    </nav>
  </aside>
  <main>
    <header>
      <div><h1>Settings</h1><p class="header-subtitle">System configuration</p></div>
    </header>
    <div class="card" style="padding:32px;text-align:center;color:var(--text-light);">
      <i class="fa-solid fa-gear" style="font-size:48px;margin-bottom:16px;"></i>
