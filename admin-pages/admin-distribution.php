  ...
  <aside class="sidebar">
    ...
    <nav class="side-nav">
      <ul>
        ...
        <li><a href="admin-organization.php" class="nav-link"><i class="fa-solid fa-building"></i> Organizations</a></li></ul>
    </nav>
  </aside>
    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        <div class="stat-content">
          ...
          <div class="stat-value" id="totalDistributions"><?php echo $row['total']; ?></div>
  ...
  <div class="modal" id="distributionModal">
    <div class="modal-content modal-large">
      ...
      <div class="modal-body">
        <form method="POST" id="distributionForm" action="../api/auth/save_distribution.php">
          <input type="hidden" id="distributionId" name="distributionId">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" id="location" name="location" required placeholder="e.g., Barangay Malubog Evacuation Center">
              </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="distributionType" name="distributionType" required>
              ...
              <div class="form-group">
                ...
                <input type="number" id="beneficiaries" name="beneficiaries" required min="1" placeholder="Number of families/individuals">
              </div>
            </div>
          </div>

          <div class="form-section" id="monetarySection" name="monetarySection" style="display: none;">
            ...
            <div class="form-group">
              ...
              <input type="number" id="monetaryAmount" name="monetaryAmount" min="0" step="100" placeholder="₱ 0.00">
              <small class="form-help">Total amount will be calculated based on number of beneficiaries</small>
            </div>
          </div>

          <div class="form-section" id="itemsSection" name="itemsSection" style="display: none;">
            ...
            <div class="items-grid">
              <div class="item-input-group">
                ...
                <input type="number" id="riceQty" name="riceQty" min="0" value="0">
                <small class="stock-info">Available: <span id="riceAvailable" name="riceAvailable">0</span></small>
              </div>
              <div class="item-input-group">
                <label for="waterQty">
                ...
                <input type="number" id="waterQty" name="waterQty" min="0" value="0">
                <small class="stock-info">Available: <span id="waterAvailable" name="waterAvailable">0</span></small>
              </div>
              <div class="item-input-group">
                <label for="cannedQty">
                ...
                <input type="number" id="cannedQty" name="cannedQty" min="0" value="0">
                <small class="stock-info">Available: <span id="cannedAvailable" name="cannedAvailable">0</span></small>
              </div>
              <div class="item-input-group">
          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <input type="text" id="teamLeader" name="teamLeader" required placeholder="Name of team leader">
            </div>
        ...
        <button type="submit" class="btn btn-primary" id="saveDistributionBtn" name="saveDistributionBtn">
